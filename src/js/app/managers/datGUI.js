...
export default class DatGUI {
  ...
  load() {
    ...
    const sceneBgColorGui = sceneFolder.addColor(Config.background, 'color').name('Background Color');
    sceneBgColorGui.onChange((value) => {
    ...
    const galaxyFolder = particleFolder.addFolder('Galaxy');
    galaxyFolder.add(Config.particles.galaxy, 'enabled').name('Enabled').onChange((value) => {
      this.particles.galaxy.setVisible(value);
    });
    galaxyFolder.add(Config.particles.galaxy, 'size').name('Size').onChange(() => {
      this.particles.galaxy.destroy();
      this.particles.galaxy.make();
    });
    galaxyFolder.add(Config.particles.galaxy, 'thetaSpread').name('Theta Spread').onChange(() => {
      this.particles.galaxy.destroy();
      this.particles.galaxy.make();
    });
    galaxyFolder.add(Config.particles.galaxy, 'thetaPiMultiplier').name('Theta PI Multiplier').onChange(() => {
      this.particles.galaxy.destroy();
      this.particles.galaxy.make();
    });
    galaxyFolder.add(Config.particles.galaxy, 'phiSpread').name('Phi Spread').onChange(() => {
      this.particles.galaxy.destroy();
      this.particles.galaxy.make();
    });
